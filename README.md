...
Подписка пользователя от имени которого сделан запрос (под чьим именем авторизован пользователь в момент запроса) на пользователя переданного в теле запроса. Анонимные запросы запрещены.
